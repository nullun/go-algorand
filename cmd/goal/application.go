...
func init() {
	...
	appCmd.PersistentFlags().IntVar(&ledgerAccountIndex, "ledger-account", -1, "Ledger hardware wallet account index (BIP-44 account). Use with Ledger wallets to sign with accounts other than the default (index 0)")
