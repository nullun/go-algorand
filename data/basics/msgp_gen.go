...
func (z *AccountData) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0009Len != 0 {
		...
		if (zb0009Mask & 0x1000) == 0 { // if not empty
			// string "sao"
			o = append(o, 0xa3, 0x73, 0x61, 0x6f)
			o = msgp.AppendInt64(o, (*z).SponsoredAssetsOffset)
		}
...
func (z *AccountData) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0009 > 0 {
			zb0009--
			(*z).SponsoredAssetsOffset, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SponsoredAssetsOffset")
				return
			}
		}
		if zb0009 > 0 {
		...
		for zb0009 > 0 {
			...
			case "sao":
				(*z).SponsoredAssetsOffset, bts, err = msgp.ReadInt64Bytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "SponsoredAssetsOffset")
					return
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (z *AssetHolding) Msgsize() (s int) {
	s = 1 + 2 + msgp.Uint64Size + 2 + msgp.BoolSize + 2 + (*z).Sponsor.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *AssetHolding) MsgIsZero() bool {
	return ((*z).Amount == 0) && ((*z).Frozen == false) && ((*z).Sponsor.MsgIsZero())
}
...
func (z *BalanceRecord) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).AccountData.SponsoredAssetsOffset == 0 {
		zb0009Len--
		zb0009Mask |= 0x4000
	}
	...
	if zb0009Len != 0 {
		...
		if (zb0009Mask & 0x4000) == 0 { // if not empty
			// string "sao"
			o = append(o, 0xa3, 0x73, 0x61, 0x6f)
			o = msgp.AppendInt64(o, (*z).AccountData.SponsoredAssetsOffset)
		}
		if (zb0009Mask & 0x8000) == 0 { // if not empty
			// string "sel"
			o = append(o, 0xa3, 0x73, 0x65, 0x6c)
...
func (z *BalanceRecord) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0009 > 0 {
			zb0009--
			(*z).AccountData.SponsoredAssetsOffset, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SponsoredAssetsOffset")
				return
			}
