...
// MarshalMsg implements msgp.Marshaler
func (z Enforcement) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	o = msgp.AppendUint8(o, uint8(z))
	return
}

func (_ Enforcement) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(Enforcement)
	if !ok {
		_, ok = (z).(*Enforcement)
	}
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *Enforcement) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	if st.AllowableDepth == 0 {
		err = msgp.ErrMaxDepthExceeded{}
		return
	}
	st.AllowableDepth--
	{
		...
		(*z) = Enforcement(zb0001)
	}
	o = bts
	return
}

func (z *Enforcement) UnmarshalMsg(bts []byte) (o []byte, err error) {
	return z.UnmarshalMsgWithState(bts, msgp.DefaultUnmarshalState)
}
func (_ *Enforcement) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*Enforcement)
	return ok
}

// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z Enforcement) Msgsize() (s int) {
	s = msgp.Uint8Size
	return
}

// MsgIsZero returns whether this is a zero value
func (z Enforcement) MsgIsZero() bool {
	return z == 0
}

// EnforcementMaxSize returns a maximum valid message size for this message type
func EnforcementMaxSize() (s int) {
	s = msgp.Uint8Size
	return
}
...
func (z *Header) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0003Len != 0 {
		if (zb0003Mask & 0x2) == 0 { // if not empty
			// string "enf"
			o = append(o, 0xa3, 0x65, 0x6e, 0x66)
			if (*z).Enforcements == nil {
				o = msgp.AppendNil(o)
			} else {
				o = msgp.AppendArrayHeader(o, uint32(len((*z).Enforcements)))
			}
			for zb0002 := range (*z).Enforcements {
				o = msgp.AppendUint8(o, uint8((*z).Enforcements[zb0002]))
			}
		}
...
func (z *Header) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0003 > 0 {
			...
			zb0007, zb0008, bts, err = msgp.ReadArrayHeaderBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Enforcements")
				return
			}
			if zb0007 > bounds.MaxTxnEnforcements {
				err = msgp.ErrOverflow(uint64(zb0007), uint64(bounds.MaxTxnEnforcements))
				err = msgp.WrapError(err, "struct-from-array", "Enforcements")
				return
			}
			if zb0008 {
				(*z).Enforcements = nil
			} else if (*z).Enforcements != nil && cap((*z).Enforcements) >= zb0007 {
				(*z).Enforcements = ((*z).Enforcements)[:zb0007]
			} else {
				(*z).Enforcements = make([]Enforcement, zb0007)
			}
			for zb0002 := range (*z).Enforcements {
				{
					var zb0009 uint8
					...
					if err != nil {
						err = msgp.WrapError(err, "struct-from-array", "Enforcements", zb0002)
						return
					}
					(*z).Enforcements[zb0002] = Enforcement(zb0009)
				}
			}
		}
		if zb0003 > 0 {
		...
		for zb0003 > 0 {
			...
			case "enf":
				...
				zb0012, zb0013, bts, err = msgp.ReadArrayHeaderBytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "Enforcements")
					return
				}
				if zb0012 > bounds.MaxTxnEnforcements {
					err = msgp.ErrOverflow(uint64(zb0012), uint64(bounds.MaxTxnEnforcements))
					err = msgp.WrapError(err, "Enforcements")
					return
				}
				if zb0013 {
					(*z).Enforcements = nil
				} else if (*z).Enforcements != nil && cap((*z).Enforcements) >= zb0012 {
					(*z).Enforcements = ((*z).Enforcements)[:zb0012]
				} else {
					(*z).Enforcements = make([]Enforcement, zb0012)
				}
				for zb0002 := range (*z).Enforcements {
					{
						var zb0014 uint8
						...
						if err != nil {
							err = msgp.WrapError(err, "Enforcements", zb0002)
							return
						}
						(*z).Enforcements[zb0002] = Enforcement(zb0014)
					}
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (z *Header) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sender.Msgsize() + 4 + (*z).Fee.Msgsize() + 3 + (*z).FirstValid.Msgsize() + 3 + (*z).LastValid.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).Note) + 4 + msgp.StringPrefixSize + len((*z).GenesisID) + 3 + (*z).GenesisHash.Msgsize() + 4 + (*z).Group.Msgsize() + 3 + msgp.ArrayHeaderSize + (32 * (msgp.ByteSize)) + 6 + (*z).RekeyTo.Msgsize() + 5 + (*z).Sponsor.Msgsize() + 4 + msgp.ArrayHeaderSize + (len((*z).Enforcements) * (msgp.Uint8Size))
	return
}

// MsgIsZero returns whether this is a zero value
func (z *Header) MsgIsZero() bool {
	return ((*z).Sender.MsgIsZero()) && ((*z).Fee.MsgIsZero()) && ((*z).FirstValid.MsgIsZero()) && ((*z).LastValid.MsgIsZero()) && (len((*z).Note) == 0) && ((*z).GenesisID == "") && ((*z).GenesisHash.MsgIsZero()) && ((*z).Group.MsgIsZero()) && ((*z).Lease == ([32]byte{})) && ((*z).RekeyTo.MsgIsZero()) && ((*z).Sponsor.MsgIsZero()) && (len((*z).Enforcements) == 0)
}
...
func HeaderMaxSize() (s int) {
	...
	// Calculating size of slice: z.Enforcements
	s += msgp.ArrayHeaderSize + ((bounds.MaxTxnEnforcements) * (msgp.Uint8Size))
	return
}
...
func (z *SignedTxn) Msgsize() (s int) {
	s = 1 + 4 + (*z).SignatureFields.Sig.Msgsize() + 5 + (*z).SignatureFields.Msig.Msgsize() + 5 + (*z).SignatureFields.Lsig.Msgsize() + 5 + (*z).SignatureFields.AuthAddr.Msgsize() + 5 + (*z).Sponsor.Msgsize() + 4 + (*z).Txn.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxn) MsgIsZero() bool {
	return ((*z).SignatureFields.Sig.MsgIsZero()) && ((*z).SignatureFields.Msig.MsgIsZero()) && ((*z).SignatureFields.Lsig.MsgIsZero()) && ((*z).SignatureFields.AuthAddr.MsgIsZero()) && ((*z).Sponsor.MsgIsZero()) && ((*z).Txn.MsgIsZero())
}
...
func (z *SignedTxnInBlock) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxnWithAD.SignedTxn.Sponsor.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x100000
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x100000) == 0 { // if not empty
			// string "spsr"
			o = append(o, 0xa4, 0x73, 0x70, 0x73, 0x72)
			o = (*z).SignedTxnWithAD.SignedTxn.Sponsor.MarshalMsg(o)
		}
...
func (z *SignedTxnInBlock) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxnWithAD.SignedTxn.Sponsor.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Sponsor")
				return
			}
...
func (z *SignedTxnInBlock) Msgsize() (s int) {
	s = 3 + 4 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.Sponsor.Msgsize() + 4 + (*z).SignedTxnWithAD.SignedTxn.Txn.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).SignedTxnWithAD.ApplyData.SenderRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ReceiverRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.CloseRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.SponsorRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.EvalDelta.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ConfigAsset.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ApplicationID.Msgsize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxnInBlock) MsgIsZero() bool {
	return ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Sponsor.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Txn.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ClosingAmount.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.AssetClosingAmount == 0) && ((*z).SignedTxnWithAD.ApplyData.SenderRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ReceiverRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.CloseRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.SponsorRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.EvalDelta.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ConfigAsset.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ApplicationID.MsgIsZero()) && ((*z).HasGenesisID == false) && ((*z).HasGenesisHash == false)
}
...
func (z *SignedTxnWithAD) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxn.Sponsor.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x20000
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x20000) == 0 { // if not empty
			// string "spsr"
			o = append(o, 0xa4, 0x73, 0x70, 0x73, 0x72)
			o = (*z).SignedTxn.Sponsor.MarshalMsg(o)
		}
		if (zb0001Mask & 0x40000) == 0 { // if not empty
			// string "txn"
			o = append(o, 0xa3, 0x74, 0x78, 0x6e)
...
func (z *SignedTxnWithAD) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxn.Sponsor.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Sponsor")
				return
			}
...
func (z *Transaction) MarshalMsg(b []byte) (o []byte) {
	...
	if len((*z).Header.Enforcements) == 0 {
		zb0009Len--
	...
	if zb0009Len != 0 {
		...
		if (zb0009Mask & 0x100000000) == 0 { // if not empty
			// string "enf"
			o = append(o, 0xa3, 0x65, 0x6e, 0x66)
			if (*z).Header.Enforcements == nil {
				o = msgp.AppendNil(o)
			} else {
				o = msgp.AppendArrayHeader(o, uint32(len((*z).Header.Enforcements)))
			}
			for zb0002 := range (*z).Header.Enforcements {
				o = msgp.AppendUint8(o, uint8((*z).Header.Enforcements[zb0002]))
			}
		}
...
func (z *Transaction) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0009 > 0 {
			...
			if zb0013 > bounds.MaxTxnEnforcements {
				err = msgp.ErrOverflow(uint64(zb0013), uint64(bounds.MaxTxnEnforcements))
				err = msgp.WrapError(err, "struct-from-array", "Enforcements")
				return
			}
			if zb0014 {
				(*z).Header.Enforcements = nil
			} else if (*z).Header.Enforcements != nil && cap((*z).Header.Enforcements) >= zb0013 {
				(*z).Header.Enforcements = ((*z).Header.Enforcements)[:zb0013]
			} else {
				(*z).Header.Enforcements = make([]Enforcement, zb0013)
			}
			for zb0002 := range (*z).Header.Enforcements {
				{
					var zb0015 uint8
					...
					(*z).Header.Enforcements[zb0002] = Enforcement(zb0015)
				}
			}
		}
		if zb0009 > 0 {
		...
		for zb0009 > 0 {
			...
			case "enf":
				...
				if zb0037 > bounds.MaxTxnEnforcements {
					err = msgp.ErrOverflow(uint64(zb0037), uint64(bounds.MaxTxnEnforcements))
					err = msgp.WrapError(err, "Enforcements")
					return
				}
				if zb0038 {
					(*z).Header.Enforcements = nil
				} else if (*z).Header.Enforcements != nil && cap((*z).Header.Enforcements) >= zb0037 {
					(*z).Header.Enforcements = ((*z).Header.Enforcements)[:zb0037]
				} else {
					(*z).Header.Enforcements = make([]Enforcement, zb0037)
				}
				for zb0002 := range (*z).Header.Enforcements {
					{
						var zb0039 uint8
						...
						(*z).Header.Enforcements[zb0002] = Enforcement(zb0039)
					}
				}
			case "votekey":
				bts, err = (*z).KeyregTxnFields.VotePK.UnmarshalMsgWithState(bts, st)
...
func TransactionMaxSize() (s int) {
	...
	s += msgp.ArrayHeaderSize + ((32) * (msgp.ByteSize))
	s += 6 + basics.AddressMaxSize() + 5 + basics.AddressMaxSize() + 4
	// Calculating size of slice: z.Header.Enforcements
	s += msgp.ArrayHeaderSize + ((bounds.MaxTxnEnforcements) * (msgp.Uint8Size))
