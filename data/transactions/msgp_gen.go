...
func (z *SignatureFields) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sig.Msgsize() + 5 + (*z).Msig.Msgsize() + 5 + (*z).Lsig.Msgsize() + 6 + (*z).PQsig.Msgsize() + 5 + (*z).AuthAddr.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignatureFields) MsgIsZero() bool {
	return ((*z).Sig.MsgIsZero()) && ((*z).Msig.MsgIsZero()) && ((*z).Lsig.MsgIsZero()) && ((*z).PQsig.MsgIsZero()) && ((*z).AuthAddr.MsgIsZero())
}

// SignatureFieldsMaxSize returns a maximum valid message size for this message type
func SignatureFieldsMaxSize() (s int) {
	s = 1 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 6 + PQSigMaxSize() + 5 + basics.AddressMaxSize()
	return
}
...
func (z *SignedTxn) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignatureFields.PQsig.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x10
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x10) == 0 { // if not empty
			// string "pqsig"
			o = append(o, 0xa5, 0x70, 0x71, 0x73, 0x69, 0x67)
			o = (*z).SignatureFields.PQsig.MarshalMsg(o)
		}
		if (zb0001Mask & 0x20) == 0 { // if not empty
			// string "sgnr"
			o = append(o, 0xa4, 0x73, 0x67, 0x6e, 0x72)
...
func (z *SignedTxn) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignatureFields.PQsig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "PQsig")
				return
			}
...
func (z *SignedTxn) Msgsize() (s int) {
	s = 1 + 4 + (*z).SignatureFields.Sig.Msgsize() + 5 + (*z).SignatureFields.Msig.Msgsize() + 5 + (*z).SignatureFields.Lsig.Msgsize() + 6 + (*z).SignatureFields.PQsig.Msgsize() + 5 + (*z).SignatureFields.AuthAddr.Msgsize() + 5 + (*z).Ssig.Msgsize() + 4 + (*z).Txn.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxn) MsgIsZero() bool {
	return ((*z).SignatureFields.Sig.MsgIsZero()) && ((*z).SignatureFields.Msig.MsgIsZero()) && ((*z).SignatureFields.Lsig.MsgIsZero()) && ((*z).SignatureFields.PQsig.MsgIsZero()) && ((*z).SignatureFields.AuthAddr.MsgIsZero()) && ((*z).Ssig.MsgIsZero()) && ((*z).Txn.MsgIsZero())
}

// SignedTxnMaxSize returns a maximum valid message size for this message type
func SignedTxnMaxSize() (s int) {
	s = 1 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 6 + PQSigMaxSize() + 5 + basics.AddressMaxSize() + 5 + SponsorSigMaxSize() + 4 + TransactionMaxSize()
	return
}
...
func (z *SignedTxnInBlock) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxnWithAD.SignedTxn.SignatureFields.PQsig.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x4000
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x4000) == 0 { // if not empty
			// string "pqsig"
			o = append(o, 0xa5, 0x70, 0x71, 0x73, 0x69, 0x67)
			o = (*z).SignedTxnWithAD.SignedTxn.SignatureFields.PQsig.MarshalMsg(o)
		}
...
func (z *SignedTxnInBlock) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxnWithAD.SignedTxn.SignatureFields.PQsig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "PQsig")
				return
			}
...
func (z *SignedTxnInBlock) Msgsize() (s int) {
	s = 3 + 4 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.Msgsize() + 6 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.PQsig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.Ssig.Msgsize() + 4 + (*z).SignedTxnWithAD.SignedTxn.Txn.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).SignedTxnWithAD.ApplyData.SenderRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ReceiverRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.CloseRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.SponsorRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.EvalDelta.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ConfigAsset.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ApplicationID.Msgsize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxnInBlock) MsgIsZero() bool {
	return ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.PQsig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Ssig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Txn.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ClosingAmount.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.AssetClosingAmount == 0) && ((*z).SignedTxnWithAD.ApplyData.SenderRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ReceiverRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.CloseRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.SponsorRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.EvalDelta.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ConfigAsset.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ApplicationID.MsgIsZero()) && ((*z).HasGenesisID == false) && ((*z).HasGenesisHash == false)
}

// SignedTxnInBlockMaxSize returns a maximum valid message size for this message type
func SignedTxnInBlockMaxSize() (s int) {
	s = 3 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 6 + PQSigMaxSize() + 5 + basics.AddressMaxSize() + 5 + SponsorSigMaxSize() + 4 + TransactionMaxSize() + 3 + basics.MicroAlgosMaxSize() + 4 + msgp.Uint64Size + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + EvalDeltaMaxSize() + 5 + basics.AssetIndexMaxSize() + 5 + basics.AppIndexMaxSize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}
...
func (z *SignedTxnWithAD) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxn.SignatureFields.PQsig.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x800
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x800) == 0 { // if not empty
			// string "pqsig"
			o = append(o, 0xa5, 0x70, 0x71, 0x73, 0x69, 0x67)
			o = (*z).SignedTxn.SignatureFields.PQsig.MarshalMsg(o)
		}
		if (zb0001Mask & 0x1000) == 0 { // if not empty
			// string "rc"
			o = append(o, 0xa2, 0x72, 0x63)
...
func (z *SignedTxnWithAD) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxn.SignatureFields.PQsig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "PQsig")
				return
			}
...
func (z *SponsorSig) Msgsize() (s int) {
	s = 1 + 5 + (*z).Sponsor.Msgsize() + 4 + (*z).SignatureFields.Sig.Msgsize() + 5 + (*z).SignatureFields.Msig.Msgsize() + 5 + (*z).SignatureFields.Lsig.Msgsize() + 6 + (*z).SignatureFields.PQsig.Msgsize() + 5 + (*z).SignatureFields.AuthAddr.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SponsorSig) MsgIsZero() bool {
	return ((*z).Sponsor.MsgIsZero()) && ((*z).SignatureFields.Sig.MsgIsZero()) && ((*z).SignatureFields.Msig.MsgIsZero()) && ((*z).SignatureFields.Lsig.MsgIsZero()) && ((*z).SignatureFields.PQsig.MsgIsZero()) && ((*z).SignatureFields.AuthAddr.MsgIsZero())
}

// SponsorSigMaxSize returns a maximum valid message size for this message type
func SponsorSigMaxSize() (s int) {
	s = 1 + 5 + basics.AddressMaxSize() + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 6 + PQSigMaxSize() + 5 + basics.AddressMaxSize()
	return
}
