...
func (z *ApplyData) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x80) == 0 { // if not empty
			// string "rf"
			o = append(o, 0xa2, 0x72, 0x66)
			o = (*z).SponsorRewards.MarshalMsg(o)
		}
...
func (z *ApplyData) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SponsorRewards.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SponsorRewards")
				return
			}
		}
		if zb0001 > 0 {
		...
		for zb0001 > 0 {
			...
			case "rf":
				bts, err = (*z).SponsorRewards.UnmarshalMsgWithState(bts, st)
				if err != nil {
					err = msgp.WrapError(err, "SponsorRewards")
					return
				}
			case "dt":
				bts, err = (*z).EvalDelta.UnmarshalMsgWithState(bts, st)
...
func (z *ApplyData) Msgsize() (s int) {
	s = 1 + 3 + (*z).ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).SenderRewards.Msgsize() + 3 + (*z).ReceiverRewards.Msgsize() + 3 + (*z).CloseRewards.Msgsize() + 3 + (*z).SponsorRewards.Msgsize() + 3 + (*z).EvalDelta.Msgsize() + 5 + (*z).ConfigAsset.Msgsize() + 5 + (*z).ApplicationID.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *ApplyData) MsgIsZero() bool {
	return ((*z).ClosingAmount.MsgIsZero()) && ((*z).AssetClosingAmount == 0) && ((*z).SenderRewards.MsgIsZero()) && ((*z).ReceiverRewards.MsgIsZero()) && ((*z).CloseRewards.MsgIsZero()) && ((*z).SponsorRewards.MsgIsZero()) && ((*z).EvalDelta.MsgIsZero()) && ((*z).ConfigAsset.MsgIsZero()) && ((*z).ApplicationID.MsgIsZero())
}

// ApplyDataMaxSize returns a maximum valid message size for this message type
func ApplyDataMaxSize() (s int) {
	s = 1 + 3 + basics.MicroAlgosMaxSize() + 4 + msgp.Uint64Size + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + EvalDeltaMaxSize() + 5 + basics.AssetIndexMaxSize() + 5 + basics.AppIndexMaxSize()
	return
}
...
// MarshalMsg implements msgp.Marshaler
func (z AssetSponsorship) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	o = msgp.AppendUint8(o, uint8(z))
	return
}

func (_ AssetSponsorship) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(AssetSponsorship)
	if !ok {
		_, ok = (z).(*AssetSponsorship)
	}
	return ok
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *AssetSponsorship) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	if st.AllowableDepth == 0 {
		err = msgp.ErrMaxDepthExceeded{}
		return
	}
	st.AllowableDepth--
	{
		...
		(*z) = AssetSponsorship(zb0001)
	}
	o = bts
	return
}

func (z *AssetSponsorship) UnmarshalMsg(bts []byte) (o []byte, err error) {
	return z.UnmarshalMsgWithState(bts, msgp.DefaultUnmarshalState)
}
func (_ *AssetSponsorship) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*AssetSponsorship)
	return ok
}

// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z AssetSponsorship) Msgsize() (s int) {
	s = msgp.Uint8Size
	return
}

// MsgIsZero returns whether this is a zero value
func (z AssetSponsorship) MsgIsZero() bool {
	return z == 0
}

// AssetSponsorshipMaxSize returns a maximum valid message size for this message type
func AssetSponsorshipMaxSize() (s int) {
	s = msgp.Uint8Size
	return
}
...
func (z *AssetTransferTxnFields) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x20) == 0 { // if not empty
			// string "aspsr"
			o = append(o, 0xa5, 0x61, 0x73, 0x70, 0x73, 0x72)
			o = msgp.AppendUint8(o, uint8((*z).AssetSponsorship))
		}
		if (zb0001Mask & 0x40) == 0 { // if not empty
			// string "xaid"
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			{
				...
				if err != nil {
					err = msgp.WrapError(err, "struct-from-array", "AssetSponsorship")
					return
				}
				(*z).AssetSponsorship = AssetSponsorship(zb0003)
			}
		}
		if zb0001 > 0 {
			err = msgp.ErrTooManyArrayFields(zb0001)
			...
			case "aspsr":
				{
					...
					if err != nil {
						err = msgp.WrapError(err, "AssetSponsorship")
						return
					}
					(*z).AssetSponsorship = AssetSponsorship(zb0004)
				}
			default:
				err = msgp.ErrNoField(string(field))
				if err != nil {
...
func (z *AssetTransferTxnFields) Msgsize() (s int) {
	s = 1 + 5 + (*z).XferAsset.Msgsize() + 5 + msgp.Uint64Size + 5 + (*z).AssetSender.Msgsize() + 5 + (*z).AssetReceiver.Msgsize() + 7 + (*z).AssetCloseTo.Msgsize() + 6 + msgp.Uint8Size
	return
}

// MsgIsZero returns whether this is a zero value
func (z *AssetTransferTxnFields) MsgIsZero() bool {
	return ((*z).XferAsset.MsgIsZero()) && ((*z).AssetAmount == 0) && ((*z).AssetSender.MsgIsZero()) && ((*z).AssetReceiver.MsgIsZero()) && ((*z).AssetCloseTo.MsgIsZero()) && ((*z).AssetSponsorship == 0)
}
...
func AssetTransferTxnFieldsMaxSize() (s int) {
	s = 1 + 5 + basics.AssetIndexMaxSize() + 5 + msgp.Uint64Size + 5 + basics.AddressMaxSize() + 5 + basics.AddressMaxSize() + 7 + basics.AddressMaxSize() + 6 + msgp.Uint8Size
	return
}
...
// MarshalMsg implements msgp.Marshaler
func (z Extra) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	o = msgp.AppendUint8(o, uint8(z))
	return
}

func (_ Extra) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(Extra)
	if !ok {
		_, ok = (z).(*Extra)
	}
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *Extra) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	if st.AllowableDepth == 0 {
		err = msgp.ErrMaxDepthExceeded{}
		return
	}
...
func (_ *Extra) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*Extra)
	return ok
}
...
// MsgIsZero returns whether this is a zero value
func (z Extra) MsgIsZero() bool {
	return z == 0
}

// ExtraMaxSize returns a maximum valid message size for this message type
func ExtraMaxSize() (s int) {
	s = msgp.Uint8Size
	return
}
...
func (z *Header) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0003Len != 0 {
		...
		if (zb0003Mask & 0x8) == 0 { // if not empty
			...
			o = msgp.AppendBool(o, (*z).FeeSponsored)
		}
...
func (z *Header) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0003 > 0 {
			...
			if zb0007 > bounds.MaxTxnDirectives {
				err = msgp.ErrOverflow(uint64(zb0007), uint64(bounds.MaxTxnDirectives))
				err = msgp.WrapError(err, "struct-from-array", "Directives")
				return
			}
			if zb0008 {
				(*z).Directives = nil
			} else if (*z).Directives != nil && cap((*z).Directives) >= zb0007 {
				(*z).Directives = ((*z).Directives)[:zb0007]
			} else {
				(*z).Directives = make([]Directive, zb0007)
			}
			for zb0002 := range (*z).Directives {
				{
					var zb0009 uint8
					...
					(*z).Directives[zb0002] = Directive(zb0009)
				}
			}
		}
		if zb0003 > 0 {
			zb0003--
			(*z).FeeSponsored, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "FeeSponsored")
				return
			}
		}
		if zb0003 > 0 {
		...
		for zb0003 > 0 {
			...
			case "dir":
				...
				if zb0012 > bounds.MaxTxnDirectives {
					err = msgp.ErrOverflow(uint64(zb0012), uint64(bounds.MaxTxnDirectives))
					err = msgp.WrapError(err, "Directives")
					return
				}
				if zb0013 {
					(*z).Directives = nil
				} else if (*z).Directives != nil && cap((*z).Directives) >= zb0012 {
					(*z).Directives = ((*z).Directives)[:zb0012]
				} else {
					(*z).Directives = make([]Directive, zb0012)
				}
				for zb0002 := range (*z).Directives {
					{
						var zb0014 uint8
						...
						(*z).Directives[zb0002] = Directive(zb0014)
					}
				}
			case "fs":
				(*z).FeeSponsored, bts, err = msgp.ReadBoolBytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "FeeSponsored")
					return
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (z *Header) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sender.Msgsize() + 4 + (*z).Fee.Msgsize() + 3 + (*z).FirstValid.Msgsize() + 3 + (*z).LastValid.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).Note) + 4 + msgp.StringPrefixSize + len((*z).GenesisID) + 3 + (*z).GenesisHash.Msgsize() + 4 + (*z).Group.Msgsize() + 3 + msgp.ArrayHeaderSize + (32 * (msgp.ByteSize)) + 6 + (*z).RekeyTo.Msgsize() + 4 + msgp.ArrayHeaderSize + (len((*z).Directives) * (msgp.Uint8Size)) + 3 + msgp.BoolSize
	return
}

// MsgIsZero returns whether this is a zero value
func (z *Header) MsgIsZero() bool {
	return ((*z).Sender.MsgIsZero()) && ((*z).Fee.MsgIsZero()) && ((*z).FirstValid.MsgIsZero()) && ((*z).LastValid.MsgIsZero()) && (len((*z).Note) == 0) && ((*z).GenesisID == "") && ((*z).GenesisHash.MsgIsZero()) && ((*z).Group.MsgIsZero()) && ((*z).Lease == ([32]byte{})) && ((*z).RekeyTo.MsgIsZero()) && (len((*z).Directives) == 0) && ((*z).FeeSponsored == false)
}
...
func (z *SignedTxn) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x40) == 0 { // if not empty
			// string "ssig"
			o = append(o, 0xa4, 0x73, 0x73, 0x69, 0x67)
			o = (*z).Ssig.MarshalMsg(o)
		}
		if (zb0001Mask & 0x80) == 0 { // if not empty
			// string "txn"
...
func (z *SignedTxn) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).Ssig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Ssig")
				return
			}
		}
		if zb0001 > 0 {
...
func (z *SignedTxn) Msgsize() (s int) {
	s = 1 + 4 + (*z).SignatureFields.Sig.Msgsize() + 5 + (*z).SignatureFields.Msig.Msgsize() + 5 + (*z).SignatureFields.Lsig.Msgsize() + 5 + (*z).SignatureFields.AuthAddr.Msgsize() + 5 + (*z).Ssig.Msgsize() + 4 + (*z).Txn.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxn) MsgIsZero() bool {
	return ((*z).SignatureFields.Sig.MsgIsZero()) && ((*z).SignatureFields.Msig.MsgIsZero()) && ((*z).SignatureFields.Lsig.MsgIsZero()) && ((*z).SignatureFields.AuthAddr.MsgIsZero()) && ((*z).Ssig.MsgIsZero()) && ((*z).Txn.MsgIsZero())
}

// SignedTxnMaxSize returns a maximum valid message size for this message type
func SignedTxnMaxSize() (s int) {
	s = 1 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 5 + basics.AddressMaxSize() + 5 + SponsorSigMaxSize() + 4 + TransactionMaxSize()
	return
}
...
func (z *SignedTxnInBlock) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxnWithAD.ApplyData.SponsorRewards.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x8000
	}
	...
	if (*z).SignedTxnWithAD.SignedTxn.Ssig.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x100000
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x8000) == 0 { // if not empty
			// string "rf"
			o = append(o, 0xa2, 0x72, 0x66)
			o = (*z).SignedTxnWithAD.ApplyData.SponsorRewards.MarshalMsg(o)
		}
		...
		if (zb0001Mask & 0x100000) == 0 { // if not empty
			// string "ssig"
			o = append(o, 0xa4, 0x73, 0x73, 0x69, 0x67)
			o = (*z).SignedTxnWithAD.SignedTxn.Ssig.MarshalMsg(o)
		}
...
func (z *SignedTxnInBlock) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxnWithAD.SignedTxn.Ssig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Ssig")
				return
			}
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxnWithAD.ApplyData.SponsorRewards.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SponsorRewards")
				return
			}
...
func (z *SignedTxnInBlock) Msgsize() (s int) {
	s = 3 + 4 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.Ssig.Msgsize() + 4 + (*z).SignedTxnWithAD.SignedTxn.Txn.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).SignedTxnWithAD.ApplyData.SenderRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ReceiverRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.CloseRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.SponsorRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.EvalDelta.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ConfigAsset.Msgsize() + 5 + (*z).SignedTxnWithAD.ApplyData.ApplicationID.Msgsize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxnInBlock) MsgIsZero() bool {
	return ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Sig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Msig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.Lsig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.SignatureFields.AuthAddr.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Ssig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Txn.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ClosingAmount.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.AssetClosingAmount == 0) && ((*z).SignedTxnWithAD.ApplyData.SenderRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ReceiverRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.CloseRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.SponsorRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.EvalDelta.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ConfigAsset.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ApplicationID.MsgIsZero()) && ((*z).HasGenesisID == false) && ((*z).HasGenesisHash == false)
}

// SignedTxnInBlockMaxSize returns a maximum valid message size for this message type
func SignedTxnInBlockMaxSize() (s int) {
	s = 3 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 5 + basics.AddressMaxSize() + 5 + SponsorSigMaxSize() + 4 + TransactionMaxSize() + 3 + basics.MicroAlgosMaxSize() + 4 + msgp.Uint64Size + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + EvalDeltaMaxSize() + 5 + basics.AssetIndexMaxSize() + 5 + basics.AppIndexMaxSize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}
...
func (z *SignedTxnWithAD) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).ApplyData.SponsorRewards.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x1000
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x1000) == 0 { // if not empty
			// string "rf"
			o = append(o, 0xa2, 0x72, 0x66)
			o = (*z).ApplyData.SponsorRewards.MarshalMsg(o)
		}
		if (zb0001Mask & 0x2000) == 0 { // if not empty
			// string "rr"
			o = append(o, 0xa2, 0x72, 0x72)
		...
		if (zb0001Mask & 0x20000) == 0 { // if not empty
			// string "ssig"
			o = append(o, 0xa4, 0x73, 0x73, 0x69, 0x67)
			o = (*z).SignedTxn.Ssig.MarshalMsg(o)
		}
		if (zb0001Mask & 0x40000) == 0 { // if not empty
			// string "txn"
			o = append(o, 0xa3, 0x74, 0x78, 0x6e)
...
func (z *SignedTxnWithAD) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxn.Ssig.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "Ssig")
				return
			}
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).ApplyData.SponsorRewards.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SponsorRewards")
				return
			}
...
func (z *SignedTxnWithAD) Msgsize() (s int) {
	s = 1 + 4 + (*z).SignedTxn.SignatureFields.Sig.Msgsize() + 5 + (*z).SignedTxn.SignatureFields.Msig.Msgsize() + 5 + (*z).SignedTxn.SignatureFields.Lsig.Msgsize() + 5 + (*z).SignedTxn.SignatureFields.AuthAddr.Msgsize() + 5 + (*z).SignedTxn.Ssig.Msgsize() + 4 + (*z).SignedTxn.Txn.Msgsize() + 3 + (*z).ApplyData.ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).ApplyData.SenderRewards.Msgsize() + 3 + (*z).ApplyData.ReceiverRewards.Msgsize() + 3 + (*z).ApplyData.CloseRewards.Msgsize() + 3 + (*z).ApplyData.SponsorRewards.Msgsize() + 3 + (*z).ApplyData.EvalDelta.Msgsize() + 5 + (*z).ApplyData.ConfigAsset.Msgsize() + 5 + (*z).ApplyData.ApplicationID.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxnWithAD) MsgIsZero() bool {
	return ((*z).SignedTxn.SignatureFields.Sig.MsgIsZero()) && ((*z).SignedTxn.SignatureFields.Msig.MsgIsZero()) && ((*z).SignedTxn.SignatureFields.Lsig.MsgIsZero()) && ((*z).SignedTxn.SignatureFields.AuthAddr.MsgIsZero()) && ((*z).SignedTxn.Ssig.MsgIsZero()) && ((*z).SignedTxn.Txn.MsgIsZero()) && ((*z).ApplyData.ClosingAmount.MsgIsZero()) && ((*z).ApplyData.AssetClosingAmount == 0) && ((*z).ApplyData.SenderRewards.MsgIsZero()) && ((*z).ApplyData.ReceiverRewards.MsgIsZero()) && ((*z).ApplyData.CloseRewards.MsgIsZero()) && ((*z).ApplyData.SponsorRewards.MsgIsZero()) && ((*z).ApplyData.EvalDelta.MsgIsZero()) && ((*z).ApplyData.ConfigAsset.MsgIsZero()) && ((*z).ApplyData.ApplicationID.MsgIsZero())
}

// SignedTxnWithADMaxSize returns a maximum valid message size for this message type
func SignedTxnWithADMaxSize() (s int) {
	s = 1 + 4 + crypto.SignatureMaxSize() + 5 + crypto.MultisigSigMaxSize() + 5 + LogicSigMaxSize() + 5 + basics.AddressMaxSize() + 5 + SponsorSigMaxSize() + 4 + TransactionMaxSize() + 3 + basics.MicroAlgosMaxSize() + 4 + msgp.Uint64Size + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 3 + EvalDeltaMaxSize() + 5 + basics.AssetIndexMaxSize() + 5 + basics.AppIndexMaxSize()
	return
}
...
func (_ *SponsorSig) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(*SponsorSig)
	return ok
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *SponsorSig) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	if st.AllowableDepth == 0 {
		err = msgp.ErrMaxDepthExceeded{}
		return
	}
...
func (z *SponsorSig) UnmarshalMsg(bts []byte) (o []byte, err error) {
	return z.UnmarshalMsgWithState(bts, msgp.DefaultUnmarshalState)
}
func (_ *SponsorSig) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*SponsorSig)
	return ok
}
...
func (z *SponsorSig) Msgsize() (s int) {
	s = 1 + 5 + (*z).Sponsor.Msgsize() + 4 + (*z).SignatureFields.Sig.Msgsize() + 5 + (*z).SignatureFields.Msig.Msgsize() + 5 + (*z).SignatureFields.Lsig.Msgsize() + 5 + (*z).SignatureFields.AuthAddr.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SponsorSig) MsgIsZero() bool {
	return ((*z).Sponsor.MsgIsZero()) && ((*z).SignatureFields.Sig.MsgIsZero()) && ((*z).SignatureFields.Msig.MsgIsZero()) && ((*z).SignatureFields.Lsig.MsgIsZero()) && ((*z).SignatureFields.AuthAddr.MsgIsZero())
}
...
func (z *Transaction) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).AssetTransferTxnFields.AssetSponsorship == 0 {
		zb0009Len--
	...
	if zb0009Len != 0 {
		...
		if (zb0009Mask & 0x1000000000000000) == 0 { // if not empty
			// string "xaid"
			o = append(o, 0xa4, 0x78, 0x61, 0x69, 0x64)
...
func (z *Transaction) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0009 > 0 {
			...
			if zb0013 > bounds.MaxTxnDirectives {
				err = msgp.ErrOverflow(uint64(zb0013), uint64(bounds.MaxTxnDirectives))
				err = msgp.WrapError(err, "struct-from-array", "Directives")
				return
			}
			if zb0014 {
				(*z).Header.Directives = nil
			} else if (*z).Header.Directives != nil && cap((*z).Header.Directives) >= zb0013 {
				(*z).Header.Directives = ((*z).Header.Directives)[:zb0013]
			} else {
				(*z).Header.Directives = make([]Directive, zb0013)
			}
			for zb0002 := range (*z).Header.Directives {
				{
					var zb0015 uint8
					...
					(*z).Header.Directives[zb0002] = Directive(zb0015)
				}
			}
		}
		if zb0009 > 0 {
			zb0009--
			(*z).Header.FeeSponsored, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "FeeSponsored")
				return
			}
		...
		if zb0009 > 0 {
			zb0009--
			{
				...
				(*z).AssetTransferTxnFields.AssetSponsorship = AssetSponsorship(zb0016)
			}
		}
		if zb0009 > 0 {
			zb0009--
		...
		if zb0009 > 0 {
			zb0009--
			{
				...
				(*z).ApplicationCallTxnFields.OnCompletion = OnCompletion(zb0017)
			}
		}
		if zb0009 > 0 {
			zb0009--
			...
			if zb0018 > encodedMaxApplicationArgs {
				err = msgp.ErrOverflow(uint64(zb0018), uint64(encodedMaxApplicationArgs))
				err = msgp.WrapError(err, "struct-from-array", "ApplicationArgs")
				return
			}
			if zb0019 {
				(*z).ApplicationCallTxnFields.ApplicationArgs = nil
			} else if (*z).ApplicationCallTxnFields.ApplicationArgs != nil && cap((*z).ApplicationCallTxnFields.ApplicationArgs) >= zb0018 {
				(*z).ApplicationCallTxnFields.ApplicationArgs = ((*z).ApplicationCallTxnFields.ApplicationArgs)[:zb0018]
			} else {
				(*z).ApplicationCallTxnFields.ApplicationArgs = make([][]byte, zb0018)
			}
			for zb0003 := range (*z).ApplicationCallTxnFields.ApplicationArgs {
		...
		if zb0009 > 0 {
			...
			if zb0020 > encodedMaxAccounts {
				err = msgp.ErrOverflow(uint64(zb0020), uint64(encodedMaxAccounts))
				err = msgp.WrapError(err, "struct-from-array", "Accounts")
				return
			}
			if zb0021 {
				(*z).ApplicationCallTxnFields.Accounts = nil
			} else if (*z).ApplicationCallTxnFields.Accounts != nil && cap((*z).ApplicationCallTxnFields.Accounts) >= zb0020 {
				(*z).ApplicationCallTxnFields.Accounts = ((*z).ApplicationCallTxnFields.Accounts)[:zb0020]
			} else {
				(*z).ApplicationCallTxnFields.Accounts = make([]basics.Address, zb0020)
			}
			for zb0004 := range (*z).ApplicationCallTxnFields.Accounts {
		...
		if zb0009 > 0 {
			...
			if zb0022 > encodedMaxForeignAssets {
				err = msgp.ErrOverflow(uint64(zb0022), uint64(encodedMaxForeignAssets))
				err = msgp.WrapError(err, "struct-from-array", "ForeignAssets")
				return
			}
			if zb0023 {
				(*z).ApplicationCallTxnFields.ForeignAssets = nil
			} else if (*z).ApplicationCallTxnFields.ForeignAssets != nil && cap((*z).ApplicationCallTxnFields.ForeignAssets) >= zb0022 {
				(*z).ApplicationCallTxnFields.ForeignAssets = ((*z).ApplicationCallTxnFields.ForeignAssets)[:zb0022]
			} else {
				(*z).ApplicationCallTxnFields.ForeignAssets = make([]basics.AssetIndex, zb0022)
			}
			for zb0005 := range (*z).ApplicationCallTxnFields.ForeignAssets {
		...
		if zb0009 > 0 {
			...
			if zb0024 > encodedMaxForeignApps {
				err = msgp.ErrOverflow(uint64(zb0024), uint64(encodedMaxForeignApps))
				err = msgp.WrapError(err, "struct-from-array", "ForeignApps")
				return
			}
			if zb0025 {
				(*z).ApplicationCallTxnFields.ForeignApps = nil
			} else if (*z).ApplicationCallTxnFields.ForeignApps != nil && cap((*z).ApplicationCallTxnFields.ForeignApps) >= zb0024 {
				(*z).ApplicationCallTxnFields.ForeignApps = ((*z).ApplicationCallTxnFields.ForeignApps)[:zb0024]
			} else {
				(*z).ApplicationCallTxnFields.ForeignApps = make([]basics.AppIndex, zb0024)
			}
			for zb0006 := range (*z).ApplicationCallTxnFields.ForeignApps {
		...
		if zb0009 > 0 {
			...
			if zb0026 > encodedMaxAccess {
				err = msgp.ErrOverflow(uint64(zb0026), uint64(encodedMaxAccess))
				err = msgp.WrapError(err, "struct-from-array", "Access")
				return
			}
			if zb0027 {
				(*z).ApplicationCallTxnFields.Access = nil
			} else if (*z).ApplicationCallTxnFields.Access != nil && cap((*z).ApplicationCallTxnFields.Access) >= zb0026 {
				(*z).ApplicationCallTxnFields.Access = ((*z).ApplicationCallTxnFields.Access)[:zb0026]
			} else {
				(*z).ApplicationCallTxnFields.Access = make([]ResourceRef, zb0026)
			}
			for zb0007 := range (*z).ApplicationCallTxnFields.Access {
		...
		if zb0009 > 0 {
			...
			if zb0028 > encodedMaxBoxes {
				err = msgp.ErrOverflow(uint64(zb0028), uint64(encodedMaxBoxes))
				err = msgp.WrapError(err, "struct-from-array", "Boxes")
				return
			}
			if zb0029 {
				(*z).ApplicationCallTxnFields.Boxes = nil
			} else if (*z).ApplicationCallTxnFields.Boxes != nil && cap((*z).ApplicationCallTxnFields.Boxes) >= zb0028 {
				(*z).ApplicationCallTxnFields.Boxes = ((*z).ApplicationCallTxnFields.Boxes)[:zb0028]
			} else {
				(*z).ApplicationCallTxnFields.Boxes = make([]BoxRef, zb0028)
			}
			for zb0008 := range (*z).ApplicationCallTxnFields.Boxes {
				var zb0030 int
				var zb0031 bool
				zb0030, zb0031, bts, err = msgp.ReadMapHeaderBytes(bts)
				if _, ok := err.(msgp.TypeError); ok {
					...
					if zb0030 > 0 {
						err = msgp.ErrTooManyArrayFields(zb0030)
						if err != nil {
					...
					for zb0030 > 0 {
						...
						case "n":
							...
							if zb0033 > bounds.MaxBytesKeyValueLen {
								err = msgp.ErrOverflow(uint64(zb0033), uint64(bounds.MaxBytesKeyValueLen))
								return
							}
							(*z).ApplicationCallTxnFields.Boxes[zb0008].Name, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.Boxes[zb0008].Name)
							if err != nil {
		...
		if zb0009 > 0 {
			...
			if zb0035 > bounds.MaxAvailableAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0035), uint64(bounds.MaxAvailableAppProgramLen))
				return
			}
		...
		for zb0009 > 0 {
			...
			case "note":
				...
				if zb0036 > bounds.MaxTxnNoteBytes {
					err = msgp.ErrOverflow(uint64(zb0036), uint64(bounds.MaxTxnNoteBytes))
					return
				}
				(*z).Header.Note, bts, err = msgp.ReadBytesBytes(bts, (*z).Header.Note)
				if err != nil {
			...
			case "gen":
				...
				if zb0037 > bounds.MaxGenesisIDLen {
					err = msgp.ErrOverflow(uint64(zb0037), uint64(bounds.MaxGenesisIDLen))
					return
				}
				(*z).Header.GenesisID, bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
			...
			case "dir":
				...
				if zb0038 > bounds.MaxTxnDirectives {
					err = msgp.ErrOverflow(uint64(zb0038), uint64(bounds.MaxTxnDirectives))
					err = msgp.WrapError(err, "Directives")
					return
				}
				if zb0039 {
					(*z).Header.Directives = nil
				} else if (*z).Header.Directives != nil && cap((*z).Header.Directives) >= zb0038 {
					(*z).Header.Directives = ((*z).Header.Directives)[:zb0038]
				} else {
					(*z).Header.Directives = make([]Directive, zb0038)
				}
				for zb0002 := range (*z).Header.Directives {
					{
						var zb0040 uint8
						zb0040, bts, err = msgp.ReadUint8Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "Directives", zb0002)
							return
						}
						(*z).Header.Directives[zb0002] = Directive(zb0040)
					}
				}
			case "fs":
				(*z).Header.FeeSponsored, bts, err = msgp.ReadBoolBytes(bts)
			...
			case "aspsr":
				{
					var zb0041 uint8
					zb0041, bts, err = msgp.ReadUint8Bytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "AssetSponsorship")
						return
					}
					(*z).AssetTransferTxnFields.AssetSponsorship = AssetSponsorship(zb0041)
				}
			case "fadd":
				bts, err = (*z).AssetFreezeTxnFields.FreezeAccount.UnmarshalMsgWithState(bts, st)
				if err != nil {
			...
			case "apan":
				{
					...
					(*z).ApplicationCallTxnFields.OnCompletion = OnCompletion(zb0042)
				}
			case "apaa":
				var zb0043 int
				var zb0044 bool
				...
				if zb0043 > encodedMaxApplicationArgs {
					err = msgp.ErrOverflow(uint64(zb0043), uint64(encodedMaxApplicationArgs))
					err = msgp.WrapError(err, "ApplicationArgs")
					return
				}
				if zb0044 {
					(*z).ApplicationCallTxnFields.ApplicationArgs = nil
				} else if (*z).ApplicationCallTxnFields.ApplicationArgs != nil && cap((*z).ApplicationCallTxnFields.ApplicationArgs) >= zb0043 {
					(*z).ApplicationCallTxnFields.ApplicationArgs = ((*z).ApplicationCallTxnFields.ApplicationArgs)[:zb0043]
				} else {
					(*z).ApplicationCallTxnFields.ApplicationArgs = make([][]byte, zb0043)
				}
				for zb0003 := range (*z).ApplicationCallTxnFields.ApplicationArgs {
					(*z).ApplicationCallTxnFields.ApplicationArgs[zb0003], bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ApplicationArgs[zb0003])
					if err != nil {
			...
			case "apat":
				...
				if zb0045 > encodedMaxAccounts {
					err = msgp.ErrOverflow(uint64(zb0045), uint64(encodedMaxAccounts))
					err = msgp.WrapError(err, "Accounts")
					return
				}
				if zb0046 {
					(*z).ApplicationCallTxnFields.Accounts = nil
				} else if (*z).ApplicationCallTxnFields.Accounts != nil && cap((*z).ApplicationCallTxnFields.Accounts) >= zb0045 {
					(*z).ApplicationCallTxnFields.Accounts = ((*z).ApplicationCallTxnFields.Accounts)[:zb0045]
				} else {
					(*z).ApplicationCallTxnFields.Accounts = make([]basics.Address, zb0045)
				}
				for zb0004 := range (*z).ApplicationCallTxnFields.Accounts {
					bts, err = (*z).ApplicationCallTxnFields.Accounts[zb0004].UnmarshalMsgWithState(bts, st)
					if err != nil {
			...
			case "apas":
				...
				if zb0047 > encodedMaxForeignAssets {
					err = msgp.ErrOverflow(uint64(zb0047), uint64(encodedMaxForeignAssets))
					err = msgp.WrapError(err, "ForeignAssets")
					return
				}
				if zb0048 {
					(*z).ApplicationCallTxnFields.ForeignAssets = nil
				} else if (*z).ApplicationCallTxnFields.ForeignAssets != nil && cap((*z).ApplicationCallTxnFields.ForeignAssets) >= zb0047 {
					(*z).ApplicationCallTxnFields.ForeignAssets = ((*z).ApplicationCallTxnFields.ForeignAssets)[:zb0047]
				} else {
					(*z).ApplicationCallTxnFields.ForeignAssets = make([]basics.AssetIndex, zb0047)
				}
				for zb0005 := range (*z).ApplicationCallTxnFields.ForeignAssets {
					bts, err = (*z).ApplicationCallTxnFields.ForeignAssets[zb0005].UnmarshalMsgWithState(bts, st)
					if err != nil {
			...
			case "apfa":
				...
				if zb0049 > encodedMaxForeignApps {
					err = msgp.ErrOverflow(uint64(zb0049), uint64(encodedMaxForeignApps))
					err = msgp.WrapError(err, "ForeignApps")
					return
				}
				if zb0050 {
					(*z).ApplicationCallTxnFields.ForeignApps = nil
				} else if (*z).ApplicationCallTxnFields.ForeignApps != nil && cap((*z).ApplicationCallTxnFields.ForeignApps) >= zb0049 {
					(*z).ApplicationCallTxnFields.ForeignApps = ((*z).ApplicationCallTxnFields.ForeignApps)[:zb0049]
				} else {
					(*z).ApplicationCallTxnFields.ForeignApps = make([]basics.AppIndex, zb0049)
				}
				for zb0006 := range (*z).ApplicationCallTxnFields.ForeignApps {
					bts, err = (*z).ApplicationCallTxnFields.ForeignApps[zb0006].UnmarshalMsgWithState(bts, st)
					if err != nil {
			...
			case "al":
				...
				if zb0051 > encodedMaxAccess {
					err = msgp.ErrOverflow(uint64(zb0051), uint64(encodedMaxAccess))
					err = msgp.WrapError(err, "Access")
					return
				}
				if zb0052 {
					(*z).ApplicationCallTxnFields.Access = nil
				} else if (*z).ApplicationCallTxnFields.Access != nil && cap((*z).ApplicationCallTxnFields.Access) >= zb0051 {
					(*z).ApplicationCallTxnFields.Access = ((*z).ApplicationCallTxnFields.Access)[:zb0051]
				} else {
					(*z).ApplicationCallTxnFields.Access = make([]ResourceRef, zb0051)
				}
				for zb0007 := range (*z).ApplicationCallTxnFields.Access {
					bts, err = (*z).ApplicationCallTxnFields.Access[zb0007].UnmarshalMsgWithState(bts, st)
					if err != nil {
			...
			case "apbx":
				...
				if zb0053 > encodedMaxBoxes {
					err = msgp.ErrOverflow(uint64(zb0053), uint64(encodedMaxBoxes))
					err = msgp.WrapError(err, "Boxes")
					return
				}
				if zb0054 {
					(*z).ApplicationCallTxnFields.Boxes = nil
				} else if (*z).ApplicationCallTxnFields.Boxes != nil && cap((*z).ApplicationCallTxnFields.Boxes) >= zb0053 {
					(*z).ApplicationCallTxnFields.Boxes = ((*z).ApplicationCallTxnFields.Boxes)[:zb0053]
				} else {
					(*z).ApplicationCallTxnFields.Boxes = make([]BoxRef, zb0053)
				}
				for zb0008 := range (*z).ApplicationCallTxnFields.Boxes {
					var zb0055 int
					var zb0056 bool
					...
					if _, ok := err.(msgp.TypeError); ok {
						...
						if zb0055 > 0 {
							...
							if zb0057 > bounds.MaxBytesKeyValueLen {
								err = msgp.ErrOverflow(uint64(zb0057), uint64(bounds.MaxBytesKeyValueLen))
								return
							}
							(*z).ApplicationCallTxnFields.Boxes[zb0008].Name, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.Boxes[zb0008].Name)
							if err != nil {
						...
						for zb0055 > 0 {
							...
							case "n":
								...
								if zb0058 > bounds.MaxBytesKeyValueLen {
									err = msgp.ErrOverflow(uint64(zb0058), uint64(bounds.MaxBytesKeyValueLen))
									return
								}
								(*z).ApplicationCallTxnFields.Boxes[zb0008].Name, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.Boxes[zb0008].Name)
								if err != nil {
			...
			case "apap":
				...
				if zb0059 > bounds.MaxAvailableAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0059), uint64(bounds.MaxAvailableAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ApprovalProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ApprovalProgram)
				if err != nil {
			...
			case "apsu":
				...
				if zb0060 > bounds.MaxAvailableAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0060), uint64(bounds.MaxAvailableAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ClearStateProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ClearStateProgram)
				if err != nil {
...
func (z *Transaction) Msgsize() (s int) {
	s = 3 + 5 + (*z).Type.Msgsize() + 4 + (*z).Header.Sender.Msgsize() + 4 + (*z).Header.Fee.Msgsize() + 3 + (*z).Header.FirstValid.Msgsize() + 3 + (*z).Header.LastValid.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).Header.Note) + 4 + msgp.StringPrefixSize + len((*z).Header.GenesisID) + 3 + (*z).Header.GenesisHash.Msgsize() + 4 + (*z).Header.Group.Msgsize() + 3 + msgp.ArrayHeaderSize + (32 * (msgp.ByteSize)) + 6 + (*z).Header.RekeyTo.Msgsize() + 4 + msgp.ArrayHeaderSize + (len((*z).Header.Directives) * (msgp.Uint8Size)) + 3 + msgp.BoolSize + 8 + (*z).KeyregTxnFields.VotePK.Msgsize() + 7 + (*z).KeyregTxnFields.SelectionPK.Msgsize() + 8 + (*z).KeyregTxnFields.StateProofPK.Msgsize() + 8 + (*z).KeyregTxnFields.VoteFirst.Msgsize() + 8 + (*z).KeyregTxnFields.VoteLast.Msgsize() + 7 + msgp.Uint64Size + 8 + msgp.BoolSize + 4 + (*z).PaymentTxnFields.Receiver.Msgsize() + 4 + (*z).PaymentTxnFields.Amount.Msgsize() + 6 + (*z).PaymentTxnFields.CloseRemainderTo.Msgsize() + 5 + (*z).AssetConfigTxnFields.ConfigAsset.Msgsize() + 5 + (*z).AssetConfigTxnFields.AssetParams.Msgsize() + 5 + (*z).AssetTransferTxnFields.XferAsset.Msgsize() + 5 + msgp.Uint64Size + 5 + (*z).AssetTransferTxnFields.AssetSender.Msgsize() + 5 + (*z).AssetTransferTxnFields.AssetReceiver.Msgsize() + 7 + (*z).AssetTransferTxnFields.AssetCloseTo.Msgsize() + 6 + msgp.Uint8Size + 5 + (*z).AssetFreezeTxnFields.FreezeAccount.Msgsize() + 5 + (*z).AssetFreezeTxnFields.FreezeAsset.Msgsize() + 5 + msgp.BoolSize + 5 + (*z).ApplicationCallTxnFields.ApplicationID.Msgsize() + 5 + msgp.Uint64Size + 5 + msgp.ArrayHeaderSize
	for zb0003 := range (*z).ApplicationCallTxnFields.ApplicationArgs {
