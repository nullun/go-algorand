...
func TestMarshalUnmarshalHoldingRef(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := HoldingRef{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingHoldingRef(t *testing.T) {
	protocol.RunEncodingTest(t, &HoldingRef{})
}

func BenchmarkMarshalMsgHoldingRef(b *testing.B) {
	v := HoldingRef{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgHoldingRef(b *testing.B) {
	v := HoldingRef{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalHoldingRef(b *testing.B) {
	v := HoldingRef{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalLocalsRef(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := LocalsRef{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingLocalsRef(t *testing.T) {
	protocol.RunEncodingTest(t, &LocalsRef{})
}

func BenchmarkMarshalMsgLocalsRef(b *testing.B) {
	v := LocalsRef{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgLocalsRef(b *testing.B) {
	v := LocalsRef{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalLocalsRef(b *testing.B) {
	v := LocalsRef{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalPQSig(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := PQSig{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingPQSig(t *testing.T) {
	protocol.RunEncodingTest(t, &PQSig{})
}

func BenchmarkMarshalMsgPQSig(b *testing.B) {
	v := PQSig{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgPQSig(b *testing.B) {
	v := PQSig{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalPQSig(b *testing.B) {
	v := PQSig{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalResourceRef(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := ResourceRef{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingResourceRef(t *testing.T) {
	protocol.RunEncodingTest(t, &ResourceRef{})
}

func BenchmarkMarshalMsgResourceRef(b *testing.B) {
	v := ResourceRef{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgResourceRef(b *testing.B) {
	v := ResourceRef{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalResourceRef(b *testing.B) {
	v := ResourceRef{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalSponsorSig(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := SponsorSig{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingSponsorSig(t *testing.T) {
	protocol.RunEncodingTest(t, &SponsorSig{})
}

func BenchmarkMarshalMsgSponsorSig(b *testing.B) {
	v := SponsorSig{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSponsorSig(b *testing.B) {
	v := SponsorSig{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSponsorSig(b *testing.B) {
	v := SponsorSig{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalSponsoredTransaction(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := SponsoredTransaction{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingSponsoredTransaction(t *testing.T) {
	protocol.RunEncodingTest(t, &SponsoredTransaction{})
}

func BenchmarkMarshalMsgSponsoredTransaction(b *testing.B) {
	v := SponsoredTransaction{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSponsoredTransaction(b *testing.B) {
	v := SponsoredTransaction{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSponsoredTransaction(b *testing.B) {
	v := SponsoredTransaction{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
